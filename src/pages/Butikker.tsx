        ...
        <div className="Butikker">
            ...
            <div className='Main'>
                ...
                <div className='ButikkDiv'>
                    ...
                    <p><a href='https://cuboss.se/' target='_blank'>Cuboss</a> er 
                ...
                <div className='ButikkDiv'>
                    ...
                    <p><a href='https://www.dailypuzzles.com.au/en-no' target='_blank'>Daily Puzzles</a> er 
                        en kubebutikk lokalisert i Australia. De er en stor kubebutikk, men leveringstiden kan være lang siden kubene sendes fra australia.
                    </p>
                </div>
                <div className='ButikkDiv'>
                    <h2><a href='https://nordicube.com/' target='_blank' className='HeaderLinks'>Nordicube</a></h2>
                    <p><a href='https://nordicube.com/' target='_blank'>Nordicube</a> er 
                ...
                <div className='ButikkDiv'>
                    ...
                    <p><a href='https://www.thecubicle.com/' target='_blank'>The Cubicle</a> er
